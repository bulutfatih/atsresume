...
const Preview = () => {
  ...
  return (
    <div className="md:max-w-[60%] sticky top-0 preview rm-padding-print bg-white p-6 md:overflow-y-scroll md:h-screen">
      <A4PageWrapper>
        <ModalHighlightMenu/>
        <DragDropContext
          onDragEnd={(result) => onDragEndHandler(result, resumeData, setResumeData)}
        >
