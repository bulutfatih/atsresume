            ...
            <section className="bg-gray-100">
                <div className="h-screen max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="flex flex-col justify-center items-center h-full text-center">
                        ...
                        <Link href="/builder" className="inline-block bg-teal-800 text-white px-6 py-3 rounded-lg font-bold text-lg hover:bg-teal-700 transition duration-200 hover:-translate-y-1 transform hover:shadow-lg">
                            Make My Resume
                        </Link>
                    </div>
                </div>
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                <div className="mt-12">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div className="flex bg-white border border-slate-200 rounded-lg shadow-lg p-4">
